...
export default function BestMobile() {
    ...
    return (
        <div className='py-1'>
            ...
            <Link to={'/catedoryproducts/mobiles&accessories'} className='font-semibold text-2xl mb-5 ml-10'>Mobile</Link>
            <Carousel autoplay={true} withoutControls={false}  pauseOnHover={false} wrapAround={true}
                slidesToShow={5}
        ...
        <Link to={'/catedoryproducts/mobiles&accessories'} className='font-semibold text-2xl mb-5 ml-10'>Mobiles</Link>
        <Carousel autoplay={true} withoutControls={false}  pauseOnHover={false} wrapAround={true}
                slidesToShow={3}
                renderCenterLeftControls={({ previousSlide }) => (
                    <button onClick={previousSlide} className='h-[5.5rem] w-10 rounded-r-[5px] bg-white md:flex items-center justify-center hidden'>
